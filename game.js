...
function checkmatch(){
    ...
    {
        cards[card_chosen_id[0]].setAttribute('src','done.jpg');
        cards[card_chosen_id[1]].setAttribute('src','done.jpg');
        ...
        cards[card_chosen_id[0]].setAttribute('src','bg.jpg')
        cards[card_chosen_id[1]].setAttribute('src','bg.jpg')
